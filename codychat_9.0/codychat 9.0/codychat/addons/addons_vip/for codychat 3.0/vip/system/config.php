...
<div class="page_full">
	<div>
		<div class="tab_menu">
			<ul>
				<li class="tab_menu_item tab_selected" data="vip" data-z="vip_setting"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></li>
				<li class="tab_menu_item" data="vip" data-z="vip_manage" onclick="vipLoadList();"><i class="fa fa-diamond"></i> <?php echo $lang['vip_manage']; ?></li>
				<li class="tab_menu_item" data="vip" data-z="vip_transaction" onclick="vipLoadTransaction();"><i class="fa fa-bank"></i> <?php echo $lang['vip_transaction']; ?></li>
				<li class="tab_menu_item" data="vip" data-z="vip_help"><i class="fa fa-question-circle"></i> <?php echo $lang['help']; ?></li>
			</ul>
		</div>
	</div>
