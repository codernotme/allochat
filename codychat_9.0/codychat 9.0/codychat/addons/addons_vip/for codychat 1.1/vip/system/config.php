...
<div class="page_full">
	<div>
		<div class="tab_menu">
			<ul>
				<li class="tab_menu_item tab_selected" onclick="tabZone(this, 'vip_setting', 'vip');"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></li>
				<li class="tab_menu_item" onclick="vipLoadList();tabZone(this, 'vip_manage', 'vip');"><i class="fa fa-diamond"></i> <?php echo $lang['vip_manage']; ?></li>
				<li class="tab_menu_item" onclick="vipLoadTransaction();tabZone(this, 'vip_transaction', 'vip');"><i class="fa fa-bank"></i> <?php echo $lang['vip_transaction']; ?></li>
				<li class="tab_menu_item" onclick="tabZone(this, 'vip_help', 'vip');"><i class="fa fa-question-circle"></i> <?php echo $lang['help']; ?></li>
			</ul>
		</div>
	</div>
	<div class="page_element">
		<div id="vip">
			<div id="vip_setting" class="tab_zone">
				...
				<button id="save_vip_plan" onclick="saveVip();" type="button" class="clear_top reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
			</div>
					...
					<div class="docu_content">
						<div class="docu_option_description sub_text">
							<p>
								...
								rank then that option will be added automaticly to the list of vip feature. You can also add your custom vip feature by adding them to the language file. Please 
