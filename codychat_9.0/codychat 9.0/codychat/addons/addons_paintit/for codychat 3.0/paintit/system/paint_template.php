...
function paintIcon($icon){
	global $data;
	return '<img class="paint_icon" src="' . $data['domain'] . '/addons/paintit/files/icons/' . $icon . '.svg"/>';
}
?>
<div class="brelative paint_menu">
	<div class="btable paint_back_menu">
		<div class="bcell_mid paint_item paint_itemb" onclick="openNewPaint();"><?php echo paintIcon('file'); ?></div>
		<div class="bcell_mid paint_item paint_itemb" onclick="openPaintBrush();"><?php echo paintIcon('paintbrush'); ?></div>
		<div class="bcell_mid paint_item paint_itemb" onclick="openPaintColor();"><div class="paint_colored"></div></div>
...
<div class="btable paint_back_menu">
	<div class="bcell_mid pad10" onclick="sendPaintIt();"><button class="reg_button theme_btn"><i class="fa fa-send"></i> <?php echo $lang['send']; ?></button></div>
