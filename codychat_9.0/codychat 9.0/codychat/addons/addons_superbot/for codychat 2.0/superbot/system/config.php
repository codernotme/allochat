...
<div class="page_full">
	<div>
		<div class="tab_menu">
			<ul>
				<li class="tab_menu_item tab_selected" data="spbot" data-z="superbot_add"><i class="fa fa-plus-circle"></i> <?php echo $lang['add']; ?></li>
				<li class="tab_menu_item" data="spbot" data-z="superbot_search"><i class="fa fa-search"></i> <?php echo $lang['search']; ?></li>
				<li class="tab_menu_item" data="spbot" data-z="superbot_setting"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></li>
				<li class="tab_menu_item" data="spbot" data-z="superbot_help"><i class="fa fa-question-circle"></i> <?php echo $lang['help']; ?></li>
			</ul>
		</div>
	</div>
