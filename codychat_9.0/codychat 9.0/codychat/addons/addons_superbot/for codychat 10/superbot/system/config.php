		...
		<div class="tpad15">
			<div id="spbot">
				...
				<div id="superbot_setting" class="tab_zone hide_zone">
					...
					<button id="save_superbot" onclick="saveSuperbot();" type="button" class="tmargin10 reg_button theme_btn"><?php echo $lang['save']; ?></button>
				</div>
		...
		<div class="config_section">
			<script data-cfasync="false">
				...
				findSuperbot = function(){
					...
					if(!validForm('superbot_data') || search.length < 2 ){
						return;
					}
					else {
						$.post('addons/superbot/system/action.php', {
