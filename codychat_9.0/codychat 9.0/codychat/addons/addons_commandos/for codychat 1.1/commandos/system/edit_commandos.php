...
if(!isset($_POST['edit_commandos']) || !boomAllow(10)){
	die();
}
...
<div class="pad_box">
	...
	<div class="boom_form">
		...
		<div class="setting_element ">
			...
			<textarea id="commandos_edit_output" class="full_textarea medium_textarea" type="text"><?php echo $command['command_output']; ?></textarea>
		</div>
	</div>
