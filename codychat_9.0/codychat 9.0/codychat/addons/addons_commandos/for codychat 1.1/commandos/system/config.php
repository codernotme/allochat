...
<div class="page_full">
	<div>
		<div class="tab_menu">
			<ul>
				<li class="tab_menu_item tab_selected" onclick="tabZone(this, 'commandos_add', 'commandos');"><i class="fa fa-plus-circle"></i> <?php echo $lang['add']; ?></li>
				<li class="tab_menu_item" onclick="tabZone(this, 'commandos_listing', 'commandos'); listCommandos();"><i class="fa fa-database"></i> <?php echo $lang['commandos_list']; ?></li>
				<li class="tab_menu_item" onclick="tabZone(this, 'commandos_setting', 'commandos');"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></li>
				<li class="tab_menu_item" onclick="tabZone(this, 'commandos_help', 'commandos');"><i class="fa fa-question-circle"></i> <?php echo $lang['help']; ?></li>
			</ul>
		</div>
	</div>
	<div class="page_element">
		<div id="commandos">
			...
			<div id="commandos_setting" class="tab_zone hide_zone">
				...
				<button id="save_commandos" onclick="saveCommandos();" type="button" class="clear_top reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
			</div>
