...
$id = escape($_POST['edit_commandos'], true);
		...
		<div class="form_right">
			<div class="setting_element">
				...
				<select id="commandos_edit_rank">
					<?php echo listRank($command['command_rank']); ?>
				</select>
			</div>
		</div>
	</div>
...
<div class="modal_control">
	<button id="add_bobby" onclick="saveEditCommandos();" type="button" class="reg_button theme_btn"><i class="fa fa-plus-circle"></i> <?php echo $lang['save']; ?></button>
</div>