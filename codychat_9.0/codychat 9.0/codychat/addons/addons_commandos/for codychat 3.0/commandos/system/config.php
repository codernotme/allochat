...
<div class="page_full">
	<div>
		<div class="tab_menu">
			<ul>
				<li class="tab_menu_item tab_selected" data="commandos" data-z="commandos_add"><i class="fa fa-plus-circle"></i> <?php echo $lang['add']; ?></li>
				<li class="tab_menu_item" data="commandos" data-z="commandos_listing" onclick="listCommandos();"><i class="fa fa-database"></i> <?php echo $lang['commandos_list']; ?></li>
				<li class="tab_menu_item" data="commandos" data-z="commandos_setting"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></li>
				<li class="tab_menu_item" data="commandos" data-z="commandos_help"><i class="fa fa-question-circle"></i> <?php echo $lang['help']; ?></li>
			</ul>
		</div>
	</div>
