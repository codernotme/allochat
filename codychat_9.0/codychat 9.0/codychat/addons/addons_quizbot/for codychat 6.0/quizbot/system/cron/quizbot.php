...
while($pass < 11){
	...
	$check_answer = $mysqli->query("SELECT * FROM boom_chat WHERE post_message COLLATE UTF8MB4_UNICODE_CI LIKE '%{$quiz['answer']}%' AND post_date > '$time' ORDER BY post_date ASC LIMIT 1");
