...
$(document).ready(function(){
	...
	<?php if($addons['custom2'] == 1){?>
	$('<div class="input_item main_item base_main"><i class="fa fa-microphone record" id="record_chat"></i></div>').insertAfter('#main_input_box');
	...
	<?php }?>
	<?php if($addons['custom3'] == 1){?>
	$('<div class="input_item main_item base_main"><i class="fa fa-microphone record" id="record_private"></i>').insertAfter('#private_input_box');
