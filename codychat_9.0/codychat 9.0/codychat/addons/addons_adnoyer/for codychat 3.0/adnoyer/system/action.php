...
if(isset($_POST['adnoyer_status'], $_POST['adnoyer_delay'], $_POST['adnoyer_hide'], $_POST['adnoyer_users'], $_POST['adnoyer_mlogs'])){
	$status = escape($_POST['adnoyer_status']);
	$delay = escape($_POST['adnoyer_delay']);
	$hide = escape($_POST['adnoyer_hide']);
	$users = escape($_POST['adnoyer_users']);
	$mlogs = escape($_POST['adnoyer_mlogs']);
...
if(isset($_POST['adnoyer_save'], $_POST['adnoyer_title'], $_POST['adnoyer_content'])){
	...
	if($get_back->num_rows == 1){
		...
		$content = boomTemplate('../addons/adnoyer/system/template/adnoyer_data', $adnoyer);
...
if(isset($_POST['delete_adnoyer'])){
	$id = escape($_POST['delete_adnoyer']);
