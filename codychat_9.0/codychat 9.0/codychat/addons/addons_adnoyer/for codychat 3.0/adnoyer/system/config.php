...
<div class="page_full">
	<div>
		<div class="tab_menu">
			<ul>
				<li class="tab_menu_item tab_selected" data="adnoy" data-z="adnoyer_setting"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></li>
				<li class="tab_menu_item" data="adnoy" data-z="adnoyer_add"><i class="fa fa-database"></i> <?php echo $lang['data']; ?></li>
				<li class="tab_menu_item" data="adnoy" data-z="adnoyer_help"><i class="fa fa-question-circle"></i> <?php echo $lang['help']; ?></li>
			</ul>
		</div>
	</div>
		...
		<div class="tpad15">
			<div id="adnoy">
				<div id="adnoyer_add" class="tab_zone hide_zone">
					<div class="bmargin15">
						<button onclick="openAdnoyer();" class="reg_button theme_btn"><i class="fa fa-plus"></i> <?php echo $lang['add']; ?></button>
					</div>
				...
				<div id="adnoyer_setting" class="tab_zone">
					...
					<div class="setting_element ">
						...
						<select id="set_adnoyer_delay">
							<?php echo optionSeconds($data['custom2'], array(15,20,30,45,60,120,180,240,300,600,1200,1800,3600)); ?>
						</select>
					</div>
					<div class="setting_element ">
						<p class="label"><?php echo $lang['adnoyer_mlogs']; ?></p>
						<select id="set_adnoyer_mlogs">
							<?php echo optionCount($data['custom4'], 3, 15, 1); ?>
						</select>
					</div>
					<div class="setting_element ">
						<p class="label"><?php echo $lang['adnoyer_users']; ?></p>
						<select id="set_adnoyer_users">
							<?php echo optionCount($data['custom5'], 1, 10, 1); ?>
						</select>
					</div>
					<div class="setting_element ">
						<p class="label"><?php echo $lang['adnoyer_hide']; ?></p>
						<select id="set_adnoyer_hide">
							<option value="99" <?php echo selCurrent($data['custom3'], 99); ?>><?php echo $lang['none']; ?></option>
