...
export default function SignUpPage({ searchParams }: SignUpPageProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        <Link href={`/sign-up/email${redirectSuffix}`} className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex h-11 w-full items-center justify-center gap-2 rounded-4xl px-3 text-sm font-medium transition-colors">
      ...
      <p className="text-muted-foreground text-center text-sm">
        ...
        <Link href={`/sign-in${redirectSuffix}`} className="text-primary font-medium hover:underline">
          Sign in
        </Link>
      </p>
    </div>
